...
const Icon = createSvgIcon(
  ...
  25.2-25.2 25.2z m0 0"
    ...
    <path
      d="M513 735.4c-15.1
  0-25.2-10.1-25.2-25.2v-403c0-15.1 10.1-25.2 25.2-25.2s25.2 10.1 25.2
  25.2v403c0 15.1-10.1 25.2-25.2 25.2z m0 0"
      p-id="4646"
    ></path>
  </>,
  'PlusSquareIcon'
...
export const PlusSquareIcon = (props: SvgIconProps) => (
